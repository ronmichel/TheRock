...
BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/hipBLAS-common"
BACKGROUND_BUILD
COMPILER_TOOLCHAIN
  amd-hip
BUILD_DEPS
...
if(_enable_rocRoller)
  therock_cmake_subproject_declare(rocRoller
    ...
    BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/rocRoller"
    BACKGROUND_BUILD
    CMAKE_ARGS
      -DHIP_PLATFORM=amd
...
therock_cmake_subproject_declare(hipBLASLt
  ...
  BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/hipBLASLt"
  BACKGROUND_BUILD
  CMAKE_ARGS
    -DHIP_PLATFORM=amd
...
therock_cmake_subproject_declare(rocBLAS
  ...
  BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/rocBLAS"
  BACKGROUND_BUILD
  CMAKE_ARGS
    -DHIP_PLATFORM=amd
    -DROCM_PATH=
...
if(THEROCK_ENABLE_SPARSE)
  ...
  therock_cmake_subproject_declare(rocSPARSE
    ...
    BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/rocSPARSE"
    BACKGROUND_BUILD
    CMAKE_ARGS
      -DHIP_PLATFORM=amd
      -DROCM_PATH=
  ...
  therock_cmake_subproject_declare(hipSPARSE
    ...
    BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/hipSPARSE"
    BACKGROUND_BUILD
    CMAKE_ARGS
      -DHIP_PLATFORM=amd
      -DROCM_PATH=
...
if(THEROCK_ENABLE_SOLVER)
  ...
  therock_cmake_subproject_declare(rocSOLVER
      ...
      BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/rocSOLVER"
      BACKGROUND_BUILD
      CMAKE_ARGS
        -DHIP_PLATFORM=amd
        -DROCM_PATH=
  ...
  therock_cmake_subproject_declare(hipSOLVER
      ...
      BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/hipSOLVER"
      BACKGROUND_BUILD
      CMAKE_ARGS
        -DHIP_PLATFORM=amd
        -DROCM_PATH=
...
therock_cmake_subproject_declare(hipBLAS
  ...
  BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/hipBLAS"
  BACKGROUND_BUILD
  CMAKE_ARGS
    -DHIP_PLATFORM=amd
    -DROCM_PATH=
