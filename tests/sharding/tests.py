...
class TestRock:
    ...
    def test_roctracer(self, orch, rock, result):
        ...
        result.testVerdict = orch.runBinary(f"{rock}/share/roctracer/run_tests.sh")
        assert result.testVerdict
    ...
    def test_hipblas(self, orch, ompEnv, rock, result):
        ...
        result.testVerdict = orch.runGtest(
            "./hipblas-test", env=ompEnv, cwd=f"{rock}/bin"
        )
        assert result.testVerdict
    ...
    def test_rocsolver(self, orch, ompEnv, rock, result):
        ...
        result.testVerdict = orch.runGtest(
            "./rocsolver-test", env=ompEnv, cwd=f"{rock}/bin"
        )
        assert result.testVerdict
    ...
    def test_hipsparse(self, orch, ompEnv, rock, result):
        ...
        result.testVerdict = orch.runGtest(
            "./hipsparse-test",
            env={
                "HIPSPARSE_CLIENTS_MATRICES_DIR": f"{rock}/clients/matrices",
                **ompEnv,
            },
            cwd=f"{rock}/bin",
        )
    ...
    def test_hipblaslt(self, orch, ompEnv, rock, result):
        ...
        result.testVerdict = orch.runGtest(
            "./hipblaslt-test", env=ompEnv, cwd=f"{rock}/bin"
        )
        assert result.testVerdict
    ...
    def test_rocsparse(self, orch, ompEnv, rock, result):
        ...
        result.testVerdict = orch.runGtest(
            ...
            gfilter="*quick*",
            env={
                "ROCSPARSE_CLIENTS_MATRICES_DIR": f"{rock}/clients/matrices",
                **ompEnv,
            },
            cwd=f"{rock}/bin",
        )
