...
if(THEROCK_ENABLE_COMPOSABLE_KERNEL)
  ...
  therock_cmake_subproject_declare(composable_kernel
    EXTERNAL_SOURCE_DIR "${THEROCK_COMPOSABLE_KERNEL_SOURCE_DIR}"
    BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/composable_kernel"
    BACKGROUND_BUILD
    CMAKE_ARGS
      -DHIP_PLATFORM=amd
      -DROCM_PATH=
...
if(THEROCK_ENABLE_MIOPEN)
  ...
  therock_cmake_subproject_declare(MIOpen
    ...
    BINARY_DIR "${THEROCK_CURRENT_BINARY_DIR}/MIOpen"
    BACKGROUND_BUILD
    CMAKE_ARGS
      -DHIP_PLATFORM=amd
      -DROCM_PATH=
